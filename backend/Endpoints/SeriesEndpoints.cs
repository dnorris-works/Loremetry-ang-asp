...
public static class SeriesEndpoints
{
    public static IEndpointRouteBuilder MapSeriesEndpoints(this IEndpointRouteBuilder app)
    {
        ...
        series.MapPut("/{id:long}/story-order", ReorderSeriesStories);
        series.MapPatch("/{seriesId:long}/documents/{documentId:long}", UpdateSeriesDocument);
    ...
    private static async Task<IResult> UpdateSeriesDocument(
        long seriesId,
        long documentId,
        ...
        CancellationToken cancellationToken)
    {
        ...
        try
        {
            var document = await SeriesService.UpdateDocumentTextAsync(
                authResult.User!.DbUserId,
                seriesId,
                documentId,
                request.TextContent,
    ...
    private static async Task<IResult> ReorderSeriesStories(
        long id,
        ...
        CancellationToken cancellationToken)
    {
        ...
        try
        {
            var stories = await StoryService.ReorderStoriesInSeriesAsync(
                authResult.User!.DbUserId,
                id,
                request,
                db,
